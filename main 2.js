...
document.querySelectorAll('.footer').forEach(footer=>{
  ...
  if(contact&&!contact.querySelector('.footer-venue')){
    ...
    venue.innerHTML=`
      ...
      <a href="https://www.google.com/maps/search/?api=1&query=S%C3%A2n+b%C3%B3ng+%C4%91%C3%A1+NOK+h%E1%BA%BBm+C4+Ph%E1%BA%A1m+H%C3%B9ng+Ch%C3%A1nh+H%C6%B0ng+TPHCM" target="_blank" rel="noopener">Hẻm C4 Phạm Hùng, P. Chánh Hưng, TP.HCM</a>
    `;

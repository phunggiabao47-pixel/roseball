      ...
      matchCentre.innerHTML=`
        ...
        <div class="match-card">
          ...
          <div style="padding:22px 8px 8px">
            ...
            <p style="margin:0 0 18px;color:#bdbdc2">Buổi tập nội bộ dành cho thành viên Rose FC.</p>
            <div class="datebox">* Giờ trên là giờ có mặt</div>
          </div>
        </div>`;
    }
...
if(path==='matches.html'){
  ...
  if(upcomingBox){
    upcomingBox.innerHTML=`
      ...
      <div style="margin-top:13px;font-size:12px;color:#8a8480">* Giờ trên là giờ có mặt.</div>`;
